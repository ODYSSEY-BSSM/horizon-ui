...
const HorizonLogo = ({
  ...
  const getViewBox = () => {
    if (symbolOnly) return '0 0 40 40';
    if (textOnly) return '40 0 108 40';
    return '0 0 148 40';
  };
  ...
  const svgContent = (
    <>
      {!textOnly && (
        <>
          <path
            d='M13 10C13.5523 10 14 10.4477 14 11V25L19 30H14L9 25V10H13ZM30 15V30H26C25.4477 30 25 29.5523 25 29V15L20 10H25L30 15Z'
            fill='#57D998'
          />
          <path
            d='M12 25L17 30H12L7 25V11C7 10.4477 7.44772 10 8 10H12V25ZM22 29C22 29.5523 21.5523 30 21 30H17V11C17 10.4477 17.4477 10 18 10H22V29ZM32 15V29C32 29.5523 31.5523 30 31 30H27V15L22 10H27L32 15Z'
            fill='#5C5CE6'
          />
        </>
      )}
  ...
  return (
    <LogoWrapper style={{ width, height }}>
      <svg
        viewBox={getViewBox()}
        fill='none'
